...
class TestYouTubeVideo:
    ...
    def test_formatted_with_views(self):
        video = YouTubeVideo(
            title="Popular Video",
...
class TestFormatYoutubeResults:
    def test_empty_results(self):
        result = format_youtube_results([], "trading bots")
    ...
    def test_multiple_results(self):
        videos = [
            YouTubeVideo("Video 1", "https://yt1.com", "Channel 1", 1000, "5:00", "20260327"),
            YouTubeVideo("Video 2", "https://yt2.com", "Channel 2", 2000, "10:00", "20260326"),
        ]
